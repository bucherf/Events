...
class eventDAO():
    ...
    def search_user(self, vorname):
        sql = "SELECT * FROM users WHERE vorname LIKE " + vorname
        self.__send_sql(sql)
...
if toDo == 'cu':
    ...
    print("Please enter the first name of the user you want to search: ")
    i_vorname_s = input()
    eventDAO.search_user(eventdao, i_vorname_s)
